...
<tr align="center">
<td align="center">
<a href="CARGADOenPAQ.asp" target="_self"><input type="button" name="cargaPAQ" value="Ver e imprimir todo lo cargado" style="FONT-SIZE: 20pt; border: 5px solid;width:600px; [b]FONT-FAMILY: Verdana, boldt[/b];
...
<a href="intermedia.asp" target="_self"><input type="button" name="intermedia" value="Ver diferencias de carga" style="FONT-SIZE: 20pt; border: 5px solid;width:600px; [b]FONT-FAMILY: Verdana, boldt[/b];
BACKGROUND-COLOR: #C0C0C0"></a>
<br>
...
<a href="intermedia.asp" target="_self"><input type="button" name="intermedia2" value="Cerrar diferencias de carga hasta ayer" style="FONT-SIZE: 20pt; border: 5px solid;width:600px; [b]FONT-FAMILY: Verdana, boldt[/b];
BACKGROUND-COLOR: #C0C0C0"></a>
<br>
...
<a href="cierreFORZADO.asp" target="_self"><input type="button" name="cierreFORZADO" value="Paquetes forzados el cierre hasta ayer" style="FONT-SIZE: 20pt; width:600px;border: 5px solid; [b]FONT-FAMILY: Verdana, boldt[/b];
BACKGROUND-COLOR: #C0C0C0"></a>
<br>
...
<br>
<a href="index.asp" target="_self"><input type="button" name="inicio" value="INICIO" style="FONT-SIZE: 20pt; border: 5px solid;width: 150px; [b]FONT-FAMILY: Verdana, boldt[/b];
BACKGROUND-COLOR: #C0C0C0"></a>
</td>
</tr>
</table>
