...
<br>
<a href="index.asp" target="_self"><input type="button" name="cargaPAQ" value="INICIO" style="FONT-SIZE: 20pt; border: 5px solid;width: 150px; [b]FONT-FAMILY: Verdana, boldt[/b];
BACKGROUND-COLOR: #C0C0C0"></a>
</td>
</tr>
</table>
